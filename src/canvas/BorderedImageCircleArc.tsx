...
const BorderedImageCircleArc = () => {
  ...
  useEffect(() => {
    ...
    onLoadedImage().then(() => {
      ...
      ctx.arc(105, 105, 100, 0, Math.PI * 2);
      ctx.clip();

      // クリップされているのをみたいので、あえて画像は crop せずに全体を表示しておく
      ctx.drawImage(image.current!, 10, 10, 1024, 1280, -180, -90, 124 * 5, 128 * 5);
...
export default BorderedImageCircleArc;
